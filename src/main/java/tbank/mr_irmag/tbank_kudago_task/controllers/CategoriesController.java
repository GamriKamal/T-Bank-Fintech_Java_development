...
public class CategoriesController {
    ...
    public ResponseEntity<String> updateCategoryById(@PathVariable("id") int id, @RequestBody Locations locations) {
        try {
            Categories category = categoriesService.updateCategory(id, locations);
