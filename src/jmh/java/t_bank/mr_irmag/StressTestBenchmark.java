...
public class StressTestBenchmark {
    ...
    public void tearDown() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("StressTestBenchmark_report.txt", true))) {
            ...
            writer.write(String.format("testKafkaStressTest, %s, %.2f, %.2f, %.2f, %.2f" + "\n",
                    Mode.AverageTime,
                    ...
                    (double) totalReplicationLatencyKafka / (double) kafkaProducers.size(),
                    0));

            writer.write(String.format("testRabbitMQKafkaStressTest, %s, %.2f, %.2f, %.2f, %.2f" + "\n",
                    Mode.AverageTime,
                    ...
                    0,
                    (double) totalDeliveryAckLatencyRabbit / (double) rabbitProducers.size()));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
