...
public class LoadBalancingMultipleConsumersBenchmark {
    ...
    public void tearDown() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("LoadBalancingMultipleConsumersBenchmark_report.txt", true))) {
            ...
            writer.write(String.format("testKafkaLoadBalancingMultipleConsumers, %s, %.2f, %.2f, %.2f, %.2f" + "\n",
                    Mode.AverageTime,
            ...
            writer.write(String.format("testRabbitMQLoadBalancingMultipleConsumers, %s, %.2f, %.2f, %.2f, %.2f" + "\n",
                    Mode.AverageTime,
